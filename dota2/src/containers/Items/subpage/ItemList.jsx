      ...
      <div className="item-list-wrapper">
          {
            Object.keys(items).map((name, index) => {
              ...
              return (
                <div className="item-display" key={index} onMouseEnter={handleMouseEnter} onMouseLeave={this.handleMouseOut}>
          ...
          }
          {
            this.state.hoverInfo && (
              <div className={this.state.hoverInfo.className} style={{left: this.state.hoverInfo.left, top: this.state.hoverInfo.top}}>
                <div className="imgIcon">
                  <img width="74" height="56" src={this.state.hoverInfo[2]} alt={this.state.hoverInfo[0]}/>
                </div>
              </div>
            )
          }
